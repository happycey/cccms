		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><?php echo ($_SESSION['user']['username']); ?><i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl>
			<dt><i class="Hui-iconfont"></i>自定义功能<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Admin/Goods/index');?>" data-title="商品管理" href="javascript:void(0)">商品管理</a></li>
					<li><a data-href="<?php echo U('Admin/Funs/index');?>" data-title="函数管理" href="javascript:void(0)">函数管理</a></li>
				</ul>
			</dd>
		</dl>
    </div>
...
<script type="text/javascript" src="http://www.one.com/static/ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
